...
purple_urchin_sites <- purple_urchins %>% 
  group_by(site_full, year) %>% 
  summarise(observed = n())

ggplot(data = purple_urchin_sites, aes(x = year, y = observed)) +
  geom_bar(aes(fill = site_full), stat = "identity") +
  facet_wrap(~ site_full, scales = 'free') +
  labs(x= "Year",
       y = "Number of Observed Purple Urchins")+
  ggtitle("Purple Urchin Observations Over Time Across Study Sites (SILVA)") +
